...
export async function GET(request: Request) {
  ...
  const sortMode: Tepou30SortMode =
    sortModeParam === "expected-value"
      ? "expected-value"
      : sortModeParam === "win-rate"
        ? "win-rate"
        : sortModeParam === "profit-factor"
          ? "profit-factor"
          : sortModeParam === "risk-reward"
            ? "risk-reward"
            : sortModeParam === "day-trader"
              ? "day-trader"
              : sortModeParam === "swing-trader"
                ? "swing-trader"
                : "ai-total";
